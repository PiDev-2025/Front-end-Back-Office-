        ...
        <Card>
          <CardBody>
            <div className="clearfix">
              ...
              <h4 className="card-title mb-4">Claim Growth</h4>
            </div>
            ...
            <Row>
              ...
              <Col lg="8">
                <div id="line-chart" dir="ltr">
                  <ReactApexChart
                    series={[{ name: "New Claim", data: seriesData }]}
                    options={options}
                    type="line"
                    height={320}
